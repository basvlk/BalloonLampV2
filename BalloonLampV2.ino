...
byte STATE20[nLEDs * 3] = { 211, 0, 0, 211, 0, 0, 211, 0, 0, 211, 0, 0, 255, 255, 0, 255, 255, 0, 255, 255, 0, 255, 255, 0, 0, 0, 255, 0, 0, 255, 0, 0, 255, 0, 0, 255};
...
void loop()
{
  ...
  */
  ...
  switch (Mode) {
    ...
    case 98: {// colorByte calculator - feedback to Host
        int pix = 0 ;
        byte colorByte = 0;
